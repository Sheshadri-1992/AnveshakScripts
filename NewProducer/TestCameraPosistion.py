...
def distance_in_meters(location1, location2):
    ...
    # print("Distance calculation : Received parameters ",location1," , ",location2)
    distance = geopy.distance.vincenty(location1, location2).meters
    print("The number of meters between ", location1, " and ", location2, " is ", distance)
    return distance
...
def calculate_within_radius(vehicle_pos_x, vehicle_pos_y):
    ...
    diameter = 0.000001  # Not sure what this value should be. This will have to be experimentally inferred.
